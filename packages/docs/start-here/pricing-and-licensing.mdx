...
| **Users** | Cloud: first 5 seats free; self-hosted: up to 5 users | Unlimited | Unlimited (volume pricing above 250 — [talk to sales](mailto:sales@openworklabs.com)) |
...
1. **Production use by organizations with up to 5 users.** Enterprise
   Features (analytics, SSO/SCIM, desktop policies, white-labeling) are excluded and require a plan.
