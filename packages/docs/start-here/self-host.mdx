...
<AccordionGroup>
  <Accordion title="Can I self-host OpenWork for free?">
    The desktop app is free and open source, and self-hosting the full platform is free for organizations with up to 5 users under the EE License; larger organizations need a plan. Shared keys and skills need the Team plan, and SSO, SCIM, and desktop policies need Enterprise; the same prices apply to Cloud and self-hosted deployments. See [Pricing and licensing](/start-here/pricing-and-licensing).
  </Accordion>
