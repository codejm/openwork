...
export const homeFaq: FaqEntry[] = [
  ...
  },
  {
    ...
    answer:
      "Yes. The desktop app is free and open source — you bring your own LLM provider keys. On OpenWork Cloud, the Team Starter plan includes your first 5 seats free, then $10 per seat per month, and adds API access and the Extension Marketplace. Enterprise plans have custom pricing with SSO and bring-your-own inference."
  },
  {
